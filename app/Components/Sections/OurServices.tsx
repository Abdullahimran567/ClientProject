...
function OurServices({ arr }: ServiceProps) {
  ...
  return (
    <Container>
      <div className='relative w-full  lg:h-screen grid grid-cols-1 gap-2 lg:grid-cols-2 bg-black text-white overflow-hidden pl-16 sm:pl-20 md:pl-24 pr-16 sm:pr-20 md:pr-24 py-8 sm:py-8 md:pt-8 md:pb-8 lg:pt-8 lg:pb-8 '>
        ...
        {/* LEFT SIDE */}
        <motion.div
          className='relative z-10 flex flex-col gap-4 sm:gap-6 md:gap-8 justify-center px-4 sm:px-6 md:px-10 lg:px-20 py-8 sm:py-10 md:py-0'
        ...
        {/* RIGHT SIDE CARD */}
        <motion.div
          className='relative z-10 flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-6 py-2 sm:py-8 md:py-0'
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true, margin: '-100px' }}
          transition={{ duration: 0.6, ease: 'easeOut' }}
